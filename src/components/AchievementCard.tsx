...
export function AchievementCard({ achievement, index }: AchievementCardProps) {
  return (
    ...
    >
      <div className="absolute -left-[41px] md:-left-[73px] top-0 w-4 h-4 bg-[var(--bg)] border border-white/20 flex items-center justify-center group-hover:border-[var(--neon-wine)] transition-all">
      ...
      <h3 className="text-2xl md:text-5xl font-black mb-6 tracking-tighter group-hover:text-white transition-colors uppercase">{achievement.title}</h3>
      <div className="text-lg md:text-2xl opacity-50 font-sans font-light leading-relaxed border-l border-white/10 pl-6 md:pl-10 relative mb-8">
      ...
      {achievement.images && achievement.images.length > 0 && (
        <div className="flex flex-wrap gap-4 pl-6 md:pl-10">
